...
@section('content')
    <div class="content-main">
        ...
        <a href="{{route('admin.file.create')}}" class="add-button">+ Aggiungi file</a>

        <div class="box px-20 pb-20 pt-20">
            <div style="margin-bottom: 20px">
                <img src="{{ asset('/img/icon/arrow-left.svg')}}" alt="">
                <a class="clickable text-dark" href="{{ route('admin.folder.index') }}">Torna indietro</a>
            </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="">
                                    <a href="{{route('admin.file.show', $file)}}" class="btn  white bg-green">
                                        Vedi
                                    </a>
                                    <a href="{{route('admin.file.edit', $file)}}" class="btn  white bg-black">
                                        Modifica
                                    </a>
