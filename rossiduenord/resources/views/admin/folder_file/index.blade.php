...
@section('content')
    <div class="content-main">
        <a href="{{route('admin.folder.create')}}" class="add-button">+ Aggiungi cartella</a>
                    ...
                    <table>
                        ...
                        <tbody id="table_ContentListFolder">
                            ...
                            <tr>
                                ...
                                <td class="">
                                    <a href="{{route('admin.folder.show', $folder->id)}}" class="btn bg-green white">
                                        Apri
                                    </a>
                                    <a href="{{route('admin.folder.edit', $folder->id)}}" class="btn white bg-black">
                                        Modifica
                                    </a>
