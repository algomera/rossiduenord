...
@section('content')
    <div class="content-main">
        <a href="{{route('admin.users.create')}}" class="add-button">+ Aggiungi Utente</a>
                    ...
                    <table>
                        ...
                        <tbody id="table_ContentList" >
                            ...
                            <tr>
                                ...
                                <td class="">
                                    <a href="{{route('admin.users.show', $user)}}" class="btn white bg-green">
                                        Vedi
                                    </a>
                                    <a href="{{route('admin.users.edit', $user)}}" class="btn white bg-black">
                                        Modifica
                                    </a>
