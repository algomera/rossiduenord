...
@include('admin.layouts.partials.search')
    ...
    <div class="content-main" style="padding-top: 0px;">
        ...
        <div class="box px-20 pt-20 pb-20"  style=" margin-bottom:0;">
            <span style="margin-right: 20px" class="black text-md {{Route::currentRouteName() == 'admin.practice.index' ? 'bold' : ''}}">
                Lista Pratiche
            </span>
            <span class="black text-md {{Route::currentRouteName() != 'admin.practice.index' ? 'bold' : ''}}">
                Scheda pratica
            </span>
