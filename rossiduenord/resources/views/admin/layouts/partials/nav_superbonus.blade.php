<div class="nav_bonus d-flex align-items-center ov-x ov-y-none">
    ...
    <a href="{{ route('business.driving_intervention', [$practice, 'PV']) }}" class="{{Route::currentRouteName() == 'business.driving_intervention' ? 'frame' : ''}} text-nowrap px-3">Interventi trainanti</a>
    <a href="{{ route('business.towed_intervention', [$practice, 'common', 'PV']) }}" class="{{Route::currentRouteName() == 'business.towed_intervention' ? 'frame' : ''}} text-nowrap px-3">Interventi trainati</a>
