<div class="grid grid-cols-10 gap-4">
	...
	{{--					<x-table.th>Ruolo</x-table.th>--}}
	{{--					<x-table.th>Files</x-table.th>--}}
	{{--				</tr>--}}
	{{--			</x-table.thead>--}}
	{{--			<x-table.tbody>--}}
	{{--				@foreach($sub_folders as $sub_folder)--}}
	{{--					<tr wire:click="$emit('openModal', '')" class="hover:bg-gray-50 cursor-pointer">--}}
	{{--						<x-table.td>--}}
	...
	{{--						</x-table.td>--}}
	{{--						<x-table.td>--}}
	{{--							<div class="max-w-2xl whitespace-normal">--}}
	{{--								{{$sub_folder->name}}--}}
	{{--							</div>--}}
	{{--						</x-table.td>--}}
	{{--						<x-table.td>{{$sub_folder->role}}</x-table.td>--}}
	{{--						<x-table.td>{{ $sub_folder->documents->count() }}</x-table.td>--}}
	{{--					</tr>--}}
	{{--				@endforeach--}}
	{{--			</x-table.tbody>--}}
	{{--		</x-table.table>--}}
