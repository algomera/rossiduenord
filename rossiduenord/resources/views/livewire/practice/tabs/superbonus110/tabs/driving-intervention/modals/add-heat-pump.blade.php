<x-card class="p-4">
	<form wire:submit.prevent="save" class="space-y-5">
		<div class="grid grid-cols-12 gap-4">
			...
			<div class="col-span-12 sm:col-span-6">
				<x-input wire:model.defer="eer" type="text" name="eer" id="eer" label="EER"></x-input>
			</div>
			<div class="col-span-12 sm:col-span-6">
			...
			<div class="col-span-12 sm:col-span-6">
				<div class="flex items-center mt-3">
					<input wire:model.defer="sonde_geotermiche"
					       id="sonde_geotermiche"
					       name="sonde_geotermiche" type="checkbox"
					       class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded">
					<label for="sonde_geotermiche"
					       class="ml-3 block text-sm font-medium text-gray-700">Sonde geotermiche</label>
				</div>
			</div>
			<div class="col-span-12 sm:col-span-6">
				<div class="flex items-center mt-3">
					<input wire:model.defer="inverter"
					       id="inverter"
					       name="inverter" type="checkbox"
					       class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded">
					<label for="inverter"
