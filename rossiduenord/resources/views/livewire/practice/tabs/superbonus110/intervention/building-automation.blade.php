<div>
	...
	<div class="mt-3 px-4">
		<div class="space-y-5">
			<div>
				<x-label>I sistemi di Building Automation dedicati al controllo di:</x-label>
				<div class="grid grid-cols-3 mt-2">
					<fieldset class="col-span-12 xl:col-span-1">
					...
					<fieldset class="col-span-12 xl:col-span-1">
						<x-label>Produzione di acqua calda sanitaria:</x-label>
						<div class="sm:flex sm:items-center sm:flex-wrap">
							<div class="flex items-center sm:mr-5 mb-2">
			...
			<div>
				...
				<p class="mt-1 text-xs text-gray-500">I dispositivi installati hanno caratteristiche e funzioni conformi a quanto previsto dal “decreto requisiti ecobonus”</p>
			</div>
			<div>
				...
				<p class="mt-1 text-xs text-gray-500">* Incluso iva e spese professionali (es. progettazione, direzione lavori, assservazione tecnica e fiscale)</p>
			</div>
			<div>
				<x-label for="ba_max_cost">La spesa massima ammissibile dal "decreto requisiti ecobonus" è pari a:</x-label>
				<div class="w-44 mb-1">
					<x-input x-mask:dynamic="$money($input, ',')"
