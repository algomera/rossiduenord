<form wire:submit.prevent="save" class="space-y-5">
	<div class="grid grid-cols-1 gap-4">
		...
		<x-input wire:model.defer="c_f" id="c_f" type="text" name="c_f" required label="Codice Fiscale"></x-input>
		...
		<x-input wire:model.defer="reg_date" id="reg_date" type="text" name="reg_date" required label="Dati registrazione"></x-input>
	</div>
