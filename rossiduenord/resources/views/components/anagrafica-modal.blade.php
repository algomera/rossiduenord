    ...
    <script>
        $(document).ready(function(){
            $(document).on('click', '.viewAnagrafica', function(e){
                ...
                axios.get(`/business/anagrafiche/${company_name}/view`)
                    .then((res) => {
                        $('#subject_type').val('');
                        ...
                        $('#phone_1').val('');
                        $('#phone_1').val(res.data.phone);
                        $('#mobile').val('');
                        $('#mobile').val(res.data.fax);
                        $('#email_1').val('');
                        $('#email_1').val(res.data.email);
                        $('#email_pec_1').val('');
                        $('#email_pec_1').val(res.data.email_pec);
                        $('#date_of_birth').val('');
