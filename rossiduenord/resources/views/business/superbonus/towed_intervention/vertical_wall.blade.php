                        ...
                        <div>{{-- BA. Bullding automation --}}
                            ...
                            <div class="d-flex align-items-center justify-content-between mt-3" style="width:100%;">
                                <div class="d-flex align-items-center">
                                    ...
                                    <label for="" class=" m-0 mr-4 black">
                                        <input type="text" value="13.636,36" style="width: 120px; background-color: #f2f2f2" class="border ml-2 px-2 text-right">
                                        €
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="mt-5">{{-- ST. Collettori solari --}}
                            ...
                            <div class="d-flex align-items-center justify-content-between mt-3" style="width:100%;">
                                <div class="d-flex align-items-center">
                                    <p class="m-0">La spesa massima ammissibile è pari a</p>
                                    <label for="" class=" m-0 mr-4 black">
                                        <input type="text" value="54.545,00" style="width: 120px; background-color: #f2f2f2" class="border ml-2 px-2 text-right">
                                        €
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="d-flex">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <input type="text" value="" style="width: 180px;" class="border ml-2 px-2 text-right">
                                    </div>
                                </div>
                            ...
                            <div class="d-flex">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <input type="text" value="0,00" style="width: 180px;" class="border ml-2 px-2 text-right">
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex align-items-center justify-content-between mt-2" style="width:100%;">
                            ...
                            <div class="d-flex">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <input type="text" value="12" style="width: 180px; background-color: #f2f2f2" class="border ml-2 px-2 text-right">
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex align-items-center justify-content-between mt-3" style="width:100%;">
                                <div class="d-flex align-items-center">
                                    <p class="m-0">La spesa massima ammissibile è pari a</p>
                                    <label for="" class=" m-0 mr-4 black">
                                        <input type="text" value="14.400,00" style="width: 120px; background-color: #f2f2f2" class="border ml-2 px-2 text-right">
                                        €
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="mt-5">{{-- EBA. Eliminazione delle barriere architettoniche --}}
                            ...
                            <div class="d-flex align-items-center justify-content-between mt-2" style="width:100%;">
                                <div class="d-flex align-items-end" style="width: 65%">
                                    <p class="m-0">
                                        ...
                                        <label for="" class=" m-0 mr-4 black">
                                            <input type="text" value="0,00" style="width: 120px;" class="border mr-2 px-2 text-right">
                                            €
                                        </label>
                                    </p>
                                </div>
                            ...
                            <div class="d-flex align-items-end mt-4" style="width: 65%">
                                <p class="m-0">
                                    ...
                                    <label for="" class=" m-0 black">
                                        <input type="text" value="0,00" style="width: 120px; background-color: #f2f2f2" class="border px-2 text-right">
                                    </label>
                            ...
                            <div class="d-flex align-items-end mt-4" style="width: 65%">
                                <p class="m-0">
                                    ...
                                    <label for="" class=" m-0 mr-4 black">
                                        <input type="text" value="0,00" style="width: 120px; background-color: #f2f2f2" class="border mr-2 px-2 text-right">
                                        €
                                    </label>
                                </p>
                            </div>
                            ...
                            <div class="d-flex align-items-center mt-5" style="width: 80%">
                                ...
                                <div class="d-flex align-items-center ml-5">
                                    ...
                                    <label for="" class="d-flex align-items-end m-0 mr-1">
                                        <input type="text" value="0,00" class="ml-2 text-right px-2 border" style="width:120px; background-color: #f2f2f2">
                                    </label>
                                    <span>€</span>
                                </div>
                            ...
                            <div class="d-flex align-items-center mt-3" style="width: 80%">
                                ...
                                <label for="" class="d-flex align-items-end black m-0 mr-1 ml-5">
                                    <input type="text" value="0,00" class="ml-2 mr-1 text-right px-2 border" style="width:120px; background-color: #f2f2f2">
                                    €
                                </label>
                            </div>
                        </div>
