        ...
        <div class="px-20 pb-20">{{-- Intervento di sostituzione degli impianti di climatizzazione invernale esistenti --}}
            ...
            <div class="mt-5">{{-- CC. Caldaie a condensazione --}}
                <div class="d-flex align-items-center mb-3">
                    ...
                    @if($condensing_boilers->count() > 0)
                        <span><strong>(Inserite: {{ $condensing_boilers->count() }})</strong></span>
                    @endif
                </div>
            ...
            <div class="mt-5">{{-- PC. Pompe di calore (PDC) --}}
                <div class="d-flex align-items-center mb-3">
                    ...
                    @if($heat_pumps->count() > 0)
                        <span><strong>(Inserite: {{ $heat_pumps->count() }})</strong></span>
                    @endif
                </div>
                <div class="px-20 pt-20 pb-20" style="width: 80%; min-height: 160px; background-color: #f2f2f2 ">
            ...
            <div class="mt-5">{{-- PCA. Pompe di calore ad assorbimento a gas --}}
                <div class="d-flex align-items-center mb-3">
                    ...
                    @if($absorption_heat_pumps->count() > 0)
                        <span><strong>(Inserite: {{ $absorption_heat_pumps->count() }})</strong></span>
                    @endif
                </div>
                <div class="px-20 pt-20 pb-20" style="width: 80%; min-height: 160px; background-color: #f2f2f2 ">
            ...
            <div class="mt-5">{{-- SI. Sistemi ibridi --}}
                <div class="d-flex align-items-center mb-3">
                    ...
                    @if($hybrid_systems->count() > 0)
                        <span><strong>(Inserite: {{ $hybrid_systems->count() }})</strong></span>
                    @endif
                </div>
                <div class="px-20 pt-20 pb-20" style="width: 80%; min-height: 160px; background-color: #f2f2f2 ">
            ...
            <div class="mt-5">{{-- CO. Sistemi di microgenerazione --}}
                <div class="d-flex align-items-center mb-3">
                    ...
                    @if($microgeneration_systems->count() > 0)
                        <span><strong>(Inserite: {{ $microgeneration_systems->count() }})</strong></span>
                    @endif
                </div>
                <div class="px-20 pt-20 pb-20" style="width: 80%; min-height: 160px; background-color: #f2f2f2 ">
            ...
            <div class="mt-5">{{--SA. Installazione di scaldacqua a pompa di calore  --}}
                <div class="d-flex align-items-center mb-3">
                    ...
                    @if($water_heatpumps_installations->count() > 0)
                        <span><strong>(Inserite: {{ $water_heatpumps_installations->count() }})</strong></span>
                    @endif
                </div>
            ...
            <div>{{-- IB. Generatori a biomamassa --}}
                <div class="mt-5">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        @if($biome_generators->count() > 0)
                            <span><strong>(Inserite: {{ $biome_generators->count() }})</strong></span>
                        @endif
                    </div>
            ...
            <div class="mt-5">{{-- Collettori solari --}}
                <div class="d-flex align-items-center mb-3">
                    ...
                    @if($solar_panels->count() > 0)
                        <span><strong>(Inserite: {{ $solar_panels->count() }})</strong></span>
                    @endif
                </div>
                <div class="px-20 pt-20 pb-20" style="width: 80%; min-height: 160px; background-color: #f2f2f2 ">
