...
@section('content')
    <div class="content-main">
        <div class="box px-20 pb-20 pt-20">
            ...
            <form action="{{ route('business.anagrafiche.update', [$anagrafica]) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <div>
                                    <input id="phone_1" type="text" style="height: 47px!important" class="form-control @error('phone_1') is-invalid @enderror" name="phone_1" value="{{ $anagrafica->phone_1 ?? old('phone_1') }}">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <div>
                                    <input id="phone_2" type="text" style="height: 47px!important" class="form-control @error('phone_2') is-invalid @enderror" name="phone_2" value="{{ $anagrafica->phone_2 ?? old('phone_2') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <div>
                                    <input id="mobile" type="text" style="height: 47px!important" class="form-control @error('mobile') is-invalid @enderror" name="mobile" value="{{ $anagrafica->mobile ?? old('mobile') }}">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <div>
                                    <input id="email_1" type="email" style="height: 47px!important" class="form-control @error('email_1') is-invalid @enderror" name="email_1" value="{{ $anagrafica->email_1 ?? old('email_1') }}">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <div>
                                    <input id="email_2" type="email" style="height: 47px!important" class="form-control @error('email_2') is-invalid @enderror" name="email_2" value="{{ $anagrafica->email_2 ?? old('email_2') }}">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <div>
                                    <input id="email_pec_1" type="email" style="height: 47px!important" class="form-control @error('email_pec_1') is-invalid @enderror" name="email_pec_1" value="{{ $anagrafica->email_pec_1 ?? old('email_pec_1') }}">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <div>
                                    <input id="email_pec_2" type="email" style="height: 47px!important" class="form-control @error('email_pec_2') is-invalid @enderror" name="email_pec_2" value="{{ $anagrafica->email_pec_2 ?? old('email_pec_2') }}">
