<script type="text/javascript">
        ...
        if ($('#biome_generators_no_data_row')) {
            ...
            $("#biome_generator_wrapper").append(`
                <div class="box_input" data-id="biome_generator-${bg}">
                                    <div class="row_input">
                                    <input type="hidden" name="biome_generators[${ah}][is_common]" id="biome_generators[${ah}][is_common]" value="{{ $is_common }}">
    ...
    function deleteBiomeGenerator(pid, cid) {
        axios.delete(`/asseverator/biome_generators/${cid}/delete`)
        .then(() => {
