<script type="text/javascript">
    ...
    function addSurface(e, t){
        ...
        $("#surface_table tbody").append(`
            <tr>
                <input type="hidden" name="surfaces[${s}][intervention]" value="{{Route::currentRouteName() == 'asseverator.driving_intervention' ? 'driving' : 'towed'}}">
    ...
    function deleteSurface(pid, cid){
        axios.delete(`/asseverator/surface/${cid}/delete`)
        .then(() => {
