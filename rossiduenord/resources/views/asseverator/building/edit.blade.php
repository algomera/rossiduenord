...
@section('content')
    @include('asseverator.layouts.partials.practiceNav')
            ...
            <div class="scroll ov-x-none">
                ...
                <form action="{{ route('asseverator.building.update', $building->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="px-20 pb-20">{{-- form di compilazione --}}
                        <div style="margin-bottom:20px;" >
                            ...
                            <input type="text" class="col-md form-control credit-input @error('intervention_name') is-invalid @enderror" name="intervention_name" id="intervention_name" value="{{old('intervention_name') ?? $building->intervention_name }}" required />
                            ...
                            <div class="form-group">
                                ...
                                <div class="position-relative">
                                    ...
                                    <select id="company_role" class="col-md form-control credit-input @error('company_role') is-invalid @enderror" name="company_role" style="height:40px; border-radius:2px; border:1px solid #DBDCDB; background-color: #F2F2F2;" required>
                        ...
                        <div class="row" style="margin-top:30px;">{{-- section form description 1 --}}
                            ...
                            <div class="col-md">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="position-relative">
                                        <div class="select"></div>
                                        <select id="build_type" class=" form-control credit-input @error('build_type') is-invalid @enderror" name="build_type" style="height:40px; border-radius:2px; border:1px solid #DBDCDB; background-color: #F2F2F2;" required>
                            ...
                            <div class="col-md">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="position-relative">
                                        <div class="select"></div>
                                        <select id="zone" class="col-md form-control credit-input @error('zone') is-invalid @enderror" name="zone" style="height:40px; border-radius:2px; border:1px solid #DBDCDB; background-color: #F2F2F2;" required >
                                            <option selected value="">Seleziona</option>
                        ...
                        <div class="mt-5">{{-- table list condomini --}}
                            ...
                            <div class="row">
                                <div class="col-md"> <!-- Data table content -->
                                    ...
                                    <a href="{{ route('asseverator.condomini.export', $building->practice) }}" class="btn bg-logo-green white mt-3">Esporta lista condomini <i class="fa-solid fa-file-arrow-down fa-1x"></i> </a>
                                        ...
                                        @if($building->imported_excel_file)
                                            <div class="d-flex" id="imported_excel_file_box">
                                                <div class="d-flex flex-column align-items-start ml-3 px-3 py-1" style="border-left: 1px solid #ced4da;">
                                                    ...
                                                    <a href="{{ route('asseverator.downloadExcel', $building->practice) }}" style="color: rgb(97, 164, 215) !important; text-decoration: underline !important;" class="font-italic font-weight-bold">{{ basename($building->imported_excel_file) }}</a>
                                                </div>
    ...
    @push('scripts')
        @include('asseverator.scripts.condomini')

        <script type="text/javascript">
            function deleteExcel(id) {
                axios.delete(`/asseverator/delete/excel/${id}`)
                .then(() => {
