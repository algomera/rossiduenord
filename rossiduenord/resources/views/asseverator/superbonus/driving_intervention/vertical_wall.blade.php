...
@section('content')
    ...
    <form action="{{ route('asseverator.update_driving_intervention', ['practice' => $practice]) }}" method="POST" class="ov-x-none">
        @csrf
        @method('PUT')
        ...
        <div class="px-20" style="padding-right: 10%">{{-- 1. Intervento di isolamento termico delle superfici opache verticali e orizzontali --}}
            ...
            <x-surface :vertwall="$vertwall" :practice="$practice" :surfaces="$surfaces" :condomino="$condominoId" :type="$type" isCommon="0"/>
