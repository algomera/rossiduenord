...
@section('content')
    <div class="content-main">
        <a href="{{route('asseverator.anagrafiche.create')}}" class="add-button">+ Aggiungi Anagrafica</a>
                        ...
                        @foreach($anagrafiche as $anagrafica)
                            <tr>
                                ...
                                <td class="d-flex align-items-center">
                                    ...
                                    <a href="{{route('asseverator.anagrafiche.edit', $anagrafica)}}" class="btn white bg-black mr-2">
                                        Modifica
                                    </a>
                                </td>
                            </tr>
