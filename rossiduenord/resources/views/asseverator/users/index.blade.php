...
@section('content')
    <div class="content-main">
        <a href="{{route('asseverator.users.create')}}" class="add-button">+ Aggiungi Utente</a>
                    ...
                    <table>
                        ...
                        <tbody id="table_ContentList" >
                            ...
                            <tr>
                                ...
                                <td class="">
                                    <a href="{{route('asseverator.users.show', $user)}}" class="btn white bg-green">
                                        Vedi
                                    </a>
                                    <a href="{{route('asseverator.users.edit', $user)}}" class="btn white bg-black">
                                        Modifica
                                    </a>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <form action="{{ Route('asseverator.users.destroy', $user->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
