    ...
    <div class="d-flex pb-20">
        ...
        <div class="px-20 pb-20" style="width: 20%; border-right: 1px solid lightgrey;">
            ...
            @foreach ($folder_documents as $folder_document)
                <div>
                    <a href="{{ route('asseverator.folderDocument.show', [$practice, $folder_document])}}">
                        <button type="button" class="folder mb-2 {{'asseverator.folderDocument.show' && request()->route()->parameter('folder_document')->name == $folder_document->name ? 'active_folder' : ''}}">
                        ...
                        <tbody>
                            @forelse($documents as $document)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a style="color: #61a4d7!important" href="{{route('asseverator.document.download',$document->id)}}">scarica</a>
                                    </td>
                                    <td class="d-flex">
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form action="{{ Route('asseverator.document.destroy', [$practice->id, $folder_document->id, $sub_folder->id, $document->id])}}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
