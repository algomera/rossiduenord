...
@section('content')
    <div class="content-main">
        ...
        <a href="{{route('asseverator.file.create')}}" class="add-button">+ Aggiungi file</a>

        <div class="box px-20 pb-20 pt-20">
            <div style="margin-bottom: 20px">
                <img src="{{ asset('/img/icon/arrow-left.svg')}}" alt="">
                <a class="clickable text-dark" href="{{ route('asseverator.folder.index') }}">Torna indietro</a>
            </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="">
                                    <a href="{{route('asseverator.file.show', $file)}}" class="btn  white bg-green">
                                        Vedi
                                    </a>
                                    <a href="{{route('asseverator.file.edit', $file)}}" class="btn  white bg-black">
                                        Modifica
                                    </a>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <form action="{{ Route('asseverator.file.destroy', $file->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
