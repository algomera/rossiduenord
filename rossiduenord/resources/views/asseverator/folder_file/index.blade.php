...
@section('content')
    <div class="content-main">
        <a href="{{route('asseverator.folder.create')}}" class="add-button">+ Aggiungi cartella</a>
                    ...
                    <table>
                        ...
                        <tbody id="table_ContentListFolder">
                            ...
                            <tr>
                                ...
                                <td class="">
                                    <a href="{{route('asseverator.folder.show', $folder->id)}}" class="btn bg-green white">
                                        Vedi
                                    </a>
                                    <a href="{{route('asseverator.folder.edit', $folder->id)}}" class="btn white bg-black">
                                        Modifica
                                    </a>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <form action="{{ Route('asseverator.folder.destroy', $folder->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
