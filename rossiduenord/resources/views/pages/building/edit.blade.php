...
@section('content')
                        ...
                        <div class="mt-5">{{-- table list condomini --}}
                            ...
                            <div class="row">
                                <div class="col-md"> <!-- Data table content -->
                                    ...
                                    <a href="{{ route('condomini.export', $building->practice) }}" class="btn bg-logo-green white mt-3">Esporta lista condomini <i class="fa-solid fa-file-arrow-down fa-1x"></i> </a>
                                        ...
                                        @if($building->imported_excel_file)
                                            <div class="d-flex" id="imported_excel_file_box">
                                                <div class="d-flex flex-column align-items-start ml-3 px-3 py-1" style="border-left: 1px solid #ced4da;">
                                                    ...
                                                    <a href="{{ route('downloadExcel', $building->practice) }}" style="color: rgb(97, 164, 215) !important; text-decoration: underline !important;" class="font-italic font-weight-bold">{{ basename($building->imported_excel_file) }}</a>
                                                </div>
    ...
    @push('scripts')
        @include('pages.scripts.condomini')

        <script type="text/javascript">
            function deleteExcel(id) {
                axios.delete(`/delete/excel/${id}`)
                .then(() => {
