<x-app-layout>
    <x-card>
        <div class="flex items-center justify-between">
            <x-page-header>Pratiche</x-page-header>
            <form class="relative w-full max-w-xl" action="">
                <div>
                    <x-input type="text" placeholder="Cerca.." id="search" name="search" append="search"></x-input>
                </div>
            </form>
        </div>
        ...
        <div class="content-main" style="padding-top: 0px;">
            ...
            <span style="margin-right: 20px" class="black text-md {{Route::currentRouteName() == 'practice.index' ? 'bold' : ''}}">
                Lista Pratiche
            </span>
