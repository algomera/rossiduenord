 ...
 */
    ...
    public function update_data_project(Request $request, Practice $practice)
    {
        ...
        $validated = $request->validate([
            ...
            'gross_surface_area' => 'nullable | integer | digits:2',
            'np' => 'nullable',
    ...
    public function update_driving_intervention(Request $request, Practice $practice)
    {
        ...
        $validated = $request->validate([
            ...
            'vw_realized_1' => 'nullable |integer |digits:2',
            'vw_realized_2' => 'nullable |integer |digits:2',
            'vw_sal_f' => 'nullable| integer |digits:2',
            'total_intervention_surface' => 'nullable|integer |digits:2',
            'total_expected_cost' => 'nullable| integer | digits:2 ',
            'max_possible_cost' => 'nullable| integer | digits:2',
            'total_isolation_cost_1' => 'nullable|integer | digits:2 ',
            'total_isolation_cost_2' => 'nullable|integer | digits:2 ',
            'final_isolation_cost' => 'nullable|integer | digits:2 ',
            'dispersing_covers' => 'nullable| integer | digits:2 ',
            'isolation_energetic_savings' => 'nullable|integer | digits:2 ',
            'winter_acs_replacing' => 'nullable|string ',
            'total_power' => 'nullable| integer | digits:2',
            ...
            'total_acs_project_cost' => 'nullable|integer | digits:2 ',
            'total_cost_installations' => 'nullable|integer | digits:2 ',
            'total_replacing_cost_1' => 'nullable|integer | digits:2 ',
            'total_replacing_cost_2' => 'nullable| integer | digits:2',
            'final_replacing_cost' => 'nullable| integer | digits:2',
            'replacing_energetic_savings' => 'nullable| integer | digits:2 ',
        ]
    );
