...
class BuildingController extends Controller
{
    ...
    public function update(Request $request, building $building)
    {
        $validated = $request->validate([
            ...
            'build_address' => 'nullable | string |min:5| max:50',
            'build_civic_number' => 'nullable | integer |min:1|max:3',
            'common' => 'nullable | string |min:2 |max:50',
            ...
            'administrator_fullname' => 'nullable | string |min:5 |max:100',
            'administrator_surname' => 'nullable | string |min:3 |max:50',
            'administrator_name' => 'nullable | string |min:3 |max:50',
            'administrator_fiscalcode' => 'nullable | string |min:16 |max:16',
            'administrator_address' => 'nullable | string |min:5 |max:100',
