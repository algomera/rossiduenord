...
class BuildingController extends Controller
{
    ...
    public function update(Request $request, building $building)
    {
        $validated = $request->validate([
            ...
            'license_number' => 'required | numeric |min:3',
            'license_date' => 'required | string |min:3',
            'construction_date' => 'required | numeric',
            ...
            'administrator_cap' => 'required | numeric',
            'administrator_telephone' => 'required | numeric | min:10',
            'administrator_cellphone' => 'required | numeric| min:10',
