...
class ApplicantController extends Controller
{
    ...
    {
        return view('asseverator.applicant.create');
    }
...
//            'lastName' => 'nullable | string | min:3 | max:100',
        ...
        return redirect()->route('asseverator.applicant.edit', $applicant);
    }
    ...
    public function edit(Applicant $applicant)
    {
        ...
        return view('asseverator.applicant.edit', compact('practice', 'subject', 'applicant', 'building'));
    }
...
//            'lastname.max'=> 'Il cognome è troppo lungo',
        ...
        return redirect()->route('asseverator.practice.edit', $applicant);
    }
