<?php
	...
	class UserController extends Controller
	{
		...
		public function index(User $user) {
			...
			return view('asseverator.users.index', compact('user', 'users'));
		}
		...
		public function create() {
			return view('asseverator.users.create');
		}
		...
		public function store(Request $request) {
			...
			return redirect()->route('asseverator.users.index')->with('message', "Nuovo utente inserito!");
		}
		...
		public function show(User $user) {
			return view('asseverator.users.show', compact('user'));
		}
		...
		public function edit(User $user) {
			return view('asseverator.users.edit', compact('user'));
		}
		...
		public function update(Request $request, User $user) {
			...
			return redirect()->route('asseverator.users.index')->with('message', "Utente aggiornato con successo!");
		}
