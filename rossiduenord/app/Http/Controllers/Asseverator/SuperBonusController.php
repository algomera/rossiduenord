...
class SuperBonusController extends Controller
{
    ...
    public function index(Practice $practice)
    {
        ...
        return view('asseverator.superbonus.index', compact('applicant', 'practice', 'building', 'subject', 'data_project'));
    }
    ...
    public function show(Practice $practice)
    {
        ...
        $subject = $practice->subject;
        $data_project = $practice->data_project;
        return view('asseverator.superbonus.data_project', compact('applicant', 'practice', 'building', 'subject', 'data_project'));
    }
    ...
    public function driving_intervention(Practice $practice, $type = 'PV', Request $request) {
        ...
        return view('asseverator.superbonus.driving_intervention.vertical_wall', compact(
            'solar_panels',
            'biome_generators',
    ...
    public function towed_intervention(Practice $practice, $condomino = 'common', $type = 'PV', Request $request) {
        ...
        return view('asseverator.superbonus.towed_intervention.vertical_wall', compact(
            'solar_panels',
            'biome_generators',
            'water_heatpumps_installations',
            'microgeneration_systems',
    ...
    public function final_state(Practice $practice) {
        ...
        return view('asseverator.superbonus.final_state_data', compact('final_state','applicant', 'practice', 'building', 'subject'));
    }
    ...
    public function fees_declaration(Practice $practice) {
        ...
        $building = $practice->building;
        $subject = $practice->subject;
        return view('asseverator.superbonus.fees_declaration', compact('applicant', 'practice', 'building', 'subject'));
    }
    ...
    public function var_computation(Practice $practice) {
        ...
        return view('asseverator.superbonus.variant.var_computation', compact('variant', 'applicant', 'practice', 'building', 'subject'));
    }
    ...
    public function update_data_project(Request $request, Practice $practice)
    {
        ...
        return redirect()->route('asseverator.driving_intervention', [$practice]);
    }
    ...
    public function update_driving_intervention(Request $request, Practice $practice)
    {
        ...
        // Redirect to next tab
        return redirect()->route('asseverator.towed_intervention', [$practice]);
    }
...
//        $practice->trainated_vert_wall()->update($request->except(['_token', '_method', 'condensing_boilers']));
        ...
        // Redirect to next tab
        return redirect()->route('asseverator.final_state', [$practice]);
    }
    ...
    public function update_final_state(Request $request, Practice $practice) {
        ...
        // Redirect to next tab
        return redirect()->route('asseverator.fees_declaration', [$practice]);
    }
    ...
    public function update_var_computation(Request $request, Practice $practice) {
        ...
        // Redirect to next tab
        $building = $practice->building;
        return redirect()->route('asseverator.superbonus.show', [$practice, $building])->with('message', 'Dati inseriti correttamente');
    }
