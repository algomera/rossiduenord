...
class FileController extends Controller
{
    ...
    {
        $folders = Folder::all();
        return view('asseverator.file_storage.create', compact('folders', 'file'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('asseverator.folder.index')->with('message', "Nuovo file inserito!");
    }
    ...
    {
        return view('asseverator.file_storage.show', compact('file'));
    }
    ...
    {
        $folders = Folder::all();
        return view('asseverator.file_storage.edit', compact('file', 'folders'));
    }
    ...
    public function update(Request $request, File $file)
    {
        ...
        return redirect()->route('asseverator.folder.show', compact('folder'))->with('message', "file modificato!");
    }
