...
class PracticeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('asseverator/practice.index', compact('practices','tot_sal', 'expected_sal'));
    }
    ...
    {
        return view('asseverator.practice.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return view('asseverator.subject.show');
    }
    ...
    public function edit(Practice $practice, Subject $subject, Applicant $applicant, Building $building)
    {
      ...
      if($practice['import'] != null){
        ...
        return view('asseverator.practice.edit', compact('practice', 'subject', 'applicant', 'building'));
    }
...
//            'name' => 'nullable | string | min:3 | max:50',
        ...
        return redirect()->route('asseverator.subject.edit', $practice);
    }
