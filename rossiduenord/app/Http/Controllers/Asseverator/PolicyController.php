...
class PolicyController extends Controller
{
    public function index(Practice $practice){
        ...
        return view('asseverator.policies.index', compact('subject','applicant','building','photos','videos','contracts','policies','practice'));
    }
    ...
    public function signedIndex(Policy $policy){
        ...
        return view('asseverator.policies.signedIndex',compact('practice','subject','modifieds','applicant','building', 'photos', 'videos', 'contracts','policy'));
    }
    ...
    public function signedStore(Request $request, Policy $policy){
        ...
        return redirect()->route('asseverator.policies.signed', $policy);
    }

    public function modifiedShow(Modified $modified){
        return view('asseverator.policies.show',compact('modified'));
    }
    ...
    public function deleteModified(Modified $modified){
        ...
        $modified->delete();
        return redirect()->route('asseverator.policies.signed',compact('policy'));
    }
}
