...
class AnagraficheController extends Controller
{
    public function index() {
        ...
        return view('asseverator.anagrafiche.index', compact('subject_roles', 'anagrafiche'));
    }

    public function create() {
        $subject_roles = SubjectRole::all();
        return view('asseverator.anagrafiche.create', compact('subject_roles'));
    }
    ...
    public function store(Request $request) {
        ...
        return redirect()->route('asseverator.anagrafiche.index')->with('message', 'Anagrafica creata con successo');;
    }

    public function edit(Anagrafica $anagrafica) {
        $subject_roles = SubjectRole::all()->except(21);
        return view('asseverator.anagrafiche.edit', compact('subject_roles', 'anagrafica'));
    }
    ...
    public function update(Anagrafica $anagrafica, Request $request) {
        ...
        return redirect()->route('asseverator.anagrafiche.index')->with('message', 'Anagrafica aggiornata con successo');
    }
