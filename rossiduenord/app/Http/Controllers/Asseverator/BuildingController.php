...
class BuildingController extends Controller
{
    ...
    {
        return view('asseverator.building.create');
    }
    ...
    public function edit(building $building, Applicant $applicant)
    {
        ...
        //dd($document);
        return view('asseverator.building.edit', compact('condomini', 'practice', 'subject', 'applicant', 'building','document'));
    }
...
//            'iban' => 'required | string |min:27 |max:27|regex:/^([A-Z]{2}[ \-]?[0-9]{2})(?=(?:[ \-]?[A-Z0-9]){9,30}$)((?:[ \-]?[A-Z0-9]{3,5}){2,7})([ \-]?[A-Z0-9]{1,3})?$/',
        ...
        [
            ...
            'fiscal_code.max' => 'Il codice fiscale deve essere lungo non più di 11 caratteri',
...
//            'iban.regex' => 'Codice non valido',
        ...
        if($request->get('condomini') > 0){
            return redirect()->route('asseverator.superbonus.index', [$practice]);
        }else{
