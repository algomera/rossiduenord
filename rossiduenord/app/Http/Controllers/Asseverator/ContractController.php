...
class ContractController extends Controller
{
    public function originalIndex(Practice $practice){
        ...
        return view('asseverator.contract.originalIndex', compact('practice','applicant','building', 'subject','videos','photos','contracts'));
    }
    ...
    public function originalStore(Request $request, Practice $practice,Contract $contract){
        ...
        return redirect()->route('asseverator.contracts.index', $practice);
    }
    ...
    public function signedIndex(Contract $contract){
        ...
        return view('asseverator.contract.signedIndex',compact('signeds','practice','applicant','building','subject','photos','videos','contract'));
    }
    ...
    public function signedStore(Request $request,Contract $contract){
        ...
        return redirect()->route('asseverator.signed.index', $contract);
    }


    public function signedShow(Signed $signed){
        return view('asseverator.contract.signedShow', compact('signed'));
    }
    ...
    public function deleteSigned(Signed $signed){
        ...
        $signed->delete();
        return redirect()->route('asseverator.signed.index',compact('contract'));
    }
}
