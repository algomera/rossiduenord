...
{
    public static function addFolders($practice_id, $folderDocument)
    {
        $session_folder = [
            [
        ...
        for ($i = 0; $i < 20; $i++) {
            Sub_folders::create($list_folders_first[$i]);
        }

        for ($i = 0; $i < 18; $i++) {
            Sub_folders::create($list_folders_during[$i]);
        }

        for ($i = 0; $i < 6; $i++) {
            Sub_folders::create($list_folders_after[$i]);
        }

        for ($i = 0; $i < 12; $i++) {
            Sub_folders::create($list_folders_casing[$i]);
        }
